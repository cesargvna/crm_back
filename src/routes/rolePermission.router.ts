...
import { createPermissionActionSchema, updatePermissionActionSchema } from '../validators/role/permissionAction.validator';
import { createPermissionAction, getAllPermissionActions, getPermissionActionById, togglePermissionActionStatus, updatePermissionAction } from '../controllers/role/permissionAction.controller';
import { createRoleSchema, getAllRolesQuerySchema, updateRoleSchema } from '../validators/role/role.validator';
import { createRole, getRoleById, getRolesBySubsidiary, getRolesBySubsidiaryComplete, getRolesByTenant, getRoleWithPermissions, toggleRoleStatus, updateRole } from '../controllers/role/role.controller';
import { createSection, getHiddenSections, getSidebarHiddenTree, getSidebarVisibilityTree, getVisibleSections, toggleSectionVisibility, updateSection } from '../controllers/role/section.controller';
import { createSectionSchema, roleIdParamSchema, toggleSectionVisibilitySchema, updateSectionSchema } from '../validators/role/section.validator';
import { createModule, getModuleById, updateModule } from '../controllers/role/module.controller';
import { createModuleSchema, updateModuleSchema } from '../validators/role/module.validator';
import { createSubmoduleSchema, updateSubmoduleSchema } from '../validators/role/submodule.validator';
import { createSubmodule, getSubmoduleById, updateSubmodule } from '../controllers/role/submodule.controller';
import { createAllowedActionSchema, getAllAllowedActionsQuerySchema } from '../validators/role/allowedAction.validator';
import { createAllowedAction, deleteAllowedAction, getAllAllowedActions } from '../controllers/role/allowedAction.controller';
import { createRolePermissionSchema, getRolePermissionsQuerySchema } from '../validators/role/rolePermission.validator';
import { createRolePermission, deleteRolePermission, getRolePermissions,  } from '../controllers/role/rolePermission.controller';
